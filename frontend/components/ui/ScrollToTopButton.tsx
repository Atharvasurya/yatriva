...
export default function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      title="Scroll to top"
      className={`fixed bottom-[148px] right-5 lg:bottom-[92px] lg:right-7 z-35 h-11 w-11 lg:h-12 lg:w-12 rounded-full flex items-center justify-center text-amber-300 border border-amber-500/30 shadow-2xl transition-all duration-300 transform hover:scale-110 active:scale-95 hover:border-amber-400 group cursor-pointer ${
        isVisible
