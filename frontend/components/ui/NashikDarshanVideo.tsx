...
export default function NashikDarshanVideo() {
  ...
  return (
    ...
    >
      <div className="p-5 sm:p-7 bg-white rounded-2xl shadow-lg border border-slate-200/80 space-y-5">
        {/* Header */}
        ...
        <div className="relative aspect-video w-full rounded-2xl overflow-hidden shadow-xl bg-black border border-slate-900 group">
          <iframe
