...
import {
  Waves, Church, Bus, ParkingCircle, AlertTriangle, Info, Map, Globe, Check, BookOpen, ChevronRight
} from 'lucide-react';
...
export default function MorePage() {
  ...
  const LINKS = [
    ...
    { key: 'temples', href: '/temples', Icon: Church, color: 'bg-orange-50 text-saffron-600' },
