...
import { Waves, MapPin, ArrowLeft, AlertTriangle, ShieldCheck, Tag } from 'lucide-react';
      ...
      <div className="card overflow-hidden p-6 space-y-5 animate-fade-up">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          >
            ...
            Snan Priority {ghat.snanPriority}
          </span>

          {!ghat.verified ? (
            <span className="placeholder-badge inline-flex items-center gap-1">
              <AlertTriangle className="h-3 w-3 text-amber-600" />
              <span>PLACEHOLDER — Unverified Field Survey</span>
            </span>
          ) : (
        ...
        {/* Name & River */}
        <div>
          <h1 className="text-3xl font-black mb-1" style={{ color: '#1B2B4B' }}>
            {name}
          </h1>
          <p className="text-sm font-bold" style={{ color: '#5B9BD5' }}>
        ...
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-600">{t('coordinatesLabel')}</span>
            <a
          ...
          <p className="text-xs font-mono text-slate-500">
            Lat: {ghat.coordinates.lat}, Lng: {ghat.coordinates.lng}
          </p>
          {!ghat.verified && (
