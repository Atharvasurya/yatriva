...
export const PARKING_ZONES: ParkingZone[] = [
  {
    ...
    pricing: { isFree: true },
    amenities: ['MSRTC Free Shuttle Bus', '24x7 Security Staff', 'Restrooms & Drinking Water', 'First Aid Station'],
    verified: true,
  },
  {
    id: 'parking-adgaon',
    ...
    pricing: { isFree: true },
    amenities: ['MSRTC Free Shuttle Bus', 'Police Aid Booth', 'Public Toilets', 'Water Distribution'],
    verified: true,
  },
  {
    id: 'parking-nilgiri',
    ...
    pricing: { isFree: true },
    amenities: ['MSRTC Free Shuttle Bus', 'Shaded Tree Area', 'Information Desk', 'Emergency Aid'],
    verified: true,
  },
  {
    id: 'parking-dugaon',
    ...
    pricing: { isFree: true },
    amenities: ['Direct Trimbak Shuttle', 'Scenic Valley Location', 'Tea & Refreshment Stalls', 'Security Gate'],
    verified: true,
  },
  {
    id: 'parking-dindori',
    ...
    imageUrl: '/images/parking/adgaon.jpg',
    pricing: { isFree: true },
    amenities: ['MSRTC Free Shuttle Bus', 'Paved Ground', 'Illuminated Night Bays'],
    verified: true,
  },
  {
    id: 'parking-panchavati-plaza',
    slug: 'panchavati-shubh-parking-plaza',
    category: 'parking',
    parkingType: 'private',
    name: {
      en: 'Shubh Residency Private Parking Plaza (Panchavati)',
      hi: 'शुभ रेजिडेंसी प्राइवेट पार्किंग प्लाजा (पंचवटी)',
      mr: 'शुभ रेसिडेन्सी खाजगी पार्किंग प्लाझा (पंचवटी)',
    },
    coordinates: { lat: 20.0055, lng: 73.7920 },
    capacityVehicles: 450,
    vehicleTypes: ['car', 'two_wheeler'],
    distanceToMainGhatKm: 0.8,
    shuttleAvailable: false,
    imageUrl: '/images/parking/panchavati_private.jpg',
    pricing: {
      currency: '₹',
      hourlyRate: 40,
      carDaily: 300,
    ...
    amenities: ['24x7 CCTV Surveillance', 'EV Fast Charging Station', 'Gated Security Barrier', '24x7 Valet Assistance', 'Clean Restrooms'],
    contactPhone: '+91 98220 14555',
    address: 'Near Kalaram Mandir East Gate, Panchavati, Nashik',
    verified: true,
  },
  {
    id: 'parking-dwarka-multilevel',
    slug: 'dwarka-mall-commercial-parking',
    category: 'parking',
    parkingType: 'commercial',
    name: {
      en: 'Dwarka Mall Multi-Level Commercial Parking',
      hi: 'द्वारका मॉल मल्टी-लेवल कमर्शियल पार्किंग',
      mr: 'द्वारका मॉल मल्टी-लेव्हल व्यावसायिक पार्किंग',
    },
    coordinates: { lat: 19.9885, lng: 73.7995 },
    capacityVehicles: 1200,
    vehicleTypes: ['car', 'two_wheeler', 'bus'],
    distanceToMainGhatKm: 3.2,
    shuttleAvailable: false,
    imageUrl: '/images/parking/dwarka_mall.jpg',
    pricing: {
      currency: '₹',
      hourlyRate: 50,
      carDaily: 350,
    ...
    amenities: ['Covered Multi-Level Decks', 'Automated Boom Barrier', 'CCTV & Security Guards', 'Elevator Access', 'E-Rickshaw & Auto Stand'],
    contactPhone: '+91 94231 78900',
    address: 'Dwarka Circle, Mumbai-Agra Highway Junction, Nashik',
    verified: true,
  },
  {
    id: 'parking-trimbak-express',
    slug: 'sai-shraddha-private-parking-trimbak',
    category: 'parking',
    parkingType: 'private',
    name: {
      en: 'Sai Shraddha Secure Private Parking & Bus Depot',
      hi: 'साईं श्रद्धा प्राइवेट सिक्योर पार्किंग एवं बस डिपो',
      mr: 'साई श्रद्धा खाजगी सुरक्षित पार्किंग व बस डेपो',
    },
    coordinates: { lat: 19.9410, lng: 73.5550 },
    capacityVehicles: 800,
    vehicleTypes: ['car', 'bus', 'two_wheeler', 'heavy_vehicle'],
    distanceToMainGhatKm: 6.0,
    shuttleAvailable: true,
    imageUrl: '/images/parking/trimbak_private.jpg',
    pricing: {
      currency: '₹',
      hourlyRate: 35,
      carDaily: 250,
    ...
    amenities: ['Covered Bus Bays', '24x7 Night Guard', 'Driver Canteen & Dormitory', 'Luggage Cloakroom', 'Private Cab Dispatch'],
    contactPhone: '+91 98902 44321',
    address: 'Trimbakeshwar Main Road, Opp. Sahyadri Valley Resort, Nashik',
    verified: true,
  },
  {
    id: 'parking-nashik-road-hub',
    slug: 'station-hub-private-parking',
    category: 'parking',
    parkingType: 'private',
    name: {
      en: 'Nashik Road Station Hub Secure Car & Bike Park',
      hi: 'नाशिक रोड स्टेशन हब सिक्योर कार एवं बाइक पार्क',
      mr: 'नाशिक रोड स्टेशन हब सुरक्षित कार व बाईक पार्क',
    },
    coordinates: { lat: 19.9550, lng: 73.8320 },
    capacityVehicles: 600,
    vehicleTypes: ['car', 'two_wheeler'],
    distanceToMainGhatKm: 8.5,
    shuttleAvailable: false,
    imageUrl: '/images/parking/adgaon.jpg',
    pricing: {
      currency: '₹',
    ...
    amenities: ['500m to Railway Station', 'Covered Two-Wheeler Sheds', 'Luggage Assistance', 'CCTV 24x7'],
    contactPhone: '+91 97654 32110',
    address: 'Datta Mandir Road, Near Nashik Road Railway Station, Nashik',
    verified: true,
  },
];
